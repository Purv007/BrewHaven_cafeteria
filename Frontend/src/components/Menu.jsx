...
const Menu = () => {
  ...
  const renderProductCard = (product) => (
    ...
    >
      ...
      {(() => {
        // Extract just the filename from the product.image path
        const imageName = product.image.split('/').pop();
        const imageUrl = `/${imageName}`;
        console.log('🖼️ Product image path:', product.image);
        console.log('🖼️ Extracted image name:', imageName);
      ...
      >
        ...
        <div style={styles.modalContent} onClick={(e) => e.stopPropagation()}>
          ...
          <div style={styles.modalBody}>
            <img 
              src={`/${modalProduct.image.split('/').pop()}?t=${Date.now()}`}
                ...
                <div style={{
                  ...
                  {productsData
                    ...
                    .map(product => (
                      ...
                      >
                        <img
                          src={`/${product.image.split('/').pop()}?t=${Date.now()}`}
                          alt={product.name}
                          style={{
                            width: '100%',
                            height: '60px',
